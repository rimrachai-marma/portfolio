...
const Header: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 mt-4 pt-4 z-50">
      <div className="container max-w-4xl mx-auto px-2 tablet_portrait:px-12 group">
          ...
          <div className="h-15 flex items-center justify-between">
            ...
            <div className="peer-checked: flex items-center justify-between gap-8">
              ...
              <div className="flex items-center justify-between gap-3">
                ...
                >
                  <MoonIcon className="dark:hidden h-4 w-auto fill-current" />
                  <SunIcon className="hidden dark:block h-4 w-auto fill-current" />
                </button>
